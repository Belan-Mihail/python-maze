...
adventure_questions = [
    ...
    {'question': 'What is the output of: `print(type(3.14))`?', 'answer': ['float']},
    ...
    {'question': 'What is the output of: `print(True and False)`?', 'answer': ['False']},
    ...
    {'question': 'What is the output of: `for i in range(5): print(i)`?', 'answer': ['0\n1\n2\n3\n4']},
    ...
    {'question': 'What is the output of: `with open("my_file.txt", "r") as f: print(f.read())`?', 'answer': ['(content of my_file.txt)']},
    {'question': 'What is the output of: `import math; print(math.sqrt(16))`?', 'answer': ['4.0']},
    {'question': 'What is the output of: `class Person: pass; person1 = Person(); print(type(person1))`?', 'answer': ["<class '__main__.Person'>"]},
    {'question': 'What is the output of: `def factorial(n): if n == 0: return 1 else: return n * factorial(n-1); print(factorial(5))`?', 'answer': ['120']},
    ...
    {'question': 'What is the output of: `my_dict = {"name": "Alice", "age": 30}; my_dict.keys()`?', 'answer': ['dict_keys(["name", "age"])']},
    {'question': 'What is the output of: `import numpy as np; arr = np.array([1, 2, 3]); print(arr.mean())`?', 'answer': ['2.0']},
    {'question': 'What is the output of: `import pandas as pd; df = pd.DataFrame({"A": [1, 2], "B": [3, 4]}); print(df.head())`?', 'answer': ['   A  B\n0  1  3\n1  2  4']},
]